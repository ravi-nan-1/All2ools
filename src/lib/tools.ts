...
export const tools: Tool[] = [
  {
    ...
    icon: 'Calculator',
    description:
      'A smart tax savings assistant that analyzes income, expenses, and region-specific rules to estimate legal tax deductions.',
    longDescription:
      'Our AI Tax Deduction Finder is a powerful, intelligent assistant designed to help individuals, freelancers, and small businesses maximize their annual tax savings. By analyzing your income statements, expense reports, receipts, and financial categories, the tool identifies potential legal tax deductions you might have missed. It stays updated with region-specific tax laws across the globe, ensuring your deductions are compliant and optimized. Stop leaving money on the table and let our AI do the heavy lifting for you during tax season.',
    features: [
      'Analyzes income and expense data',
      'Identifies region-specific deductions',
      'Supports multiple currencies',
      'Generates estimated savings reports',
    ],
    howItWorks: [
      'Connect your financial accounts or upload statements.',
      'Our AI scans for potential tax-deductible expenses.',
      'Review the categorized deductions and estimated savings.',
      'Export a report to assist with your tax filing.',
    ],
    useCases: [
      'Freelancers tracking business expenses.',
      'Small business owners preparing for tax season.',
      'Individuals looking to maximize their tax returns.',
    ],
  },
  {
